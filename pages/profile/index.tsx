          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                To create a gym community where everyone feels empowered to achieve their fitness goals, no matter their starting point." Mission: "At [Gym Name], we focus on providing personalized training, innovative workout programs, and a supportive environment where each member can grow and achieve their personal best.
                </p>
              </div>

...
const HeroSection = () => {
  ...
  return (
      ...
      {/* <!-- Footer Section Begin --> */}
       <footer class="footer-section"> 
        <div class="container">
            ...
            <div class="subscribe-option set-bg" data-setbg="img/footer-signup.jpg" style={{ "background-image": "url(/footer-banner/footer-banner-2.jpg)" }}>
                <div class="so-text">
   ...
   All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" >Colorlib</a>
